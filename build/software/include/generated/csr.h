//--------------------------------------------------------------------------------
// Auto-generated by LiteX (34ec22f8) on 2023-06-25 22:09:08
//--------------------------------------------------------------------------------
...
/* pantalla */
#define CSR_PANTALLA_BASE (CSR_BASE + 0x800L)
#define CSR_PANTALLA_ENABLE_ADDR (CSR_BASE + 0x800L)
#define CSR_PANTALLA_ENABLE_SIZE 1
static inline uint32_t pantalla_enable_read(void) {
	return csr_read_simple((CSR_BASE + 0x800L));
}
static inline void pantalla_enable_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x800L));
}
#define CSR_PANTALLA_WR_ADDR (CSR_BASE + 0x804L)
#define CSR_PANTALLA_WR_SIZE 1
static inline uint32_t pantalla_wr_read(void) {
	return csr_read_simple((CSR_BASE + 0x804L));
}
static inline void pantalla_wr_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x804L));
}
#define CSR_PANTALLA_DATALINE1_ADDR (CSR_BASE + 0x808L)
#define CSR_PANTALLA_DATALINE1_SIZE 2
static inline uint64_t pantalla_dataLine1_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x808L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x80cL));
	return r;
}
static inline void pantalla_dataLine1_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x808L));
	csr_write_simple(v, (CSR_BASE + 0x80cL));
}
#define CSR_PANTALLA_DATALINE2_ADDR (CSR_BASE + 0x810L)
#define CSR_PANTALLA_DATALINE2_SIZE 2
static inline uint64_t pantalla_dataLine2_read(void) {
	uint64_t r = csr_read_simple((CSR_BASE + 0x810L));
	r <<= 32;
	r |= csr_read_simple((CSR_BASE + 0x814L));
	return r;
}
static inline void pantalla_dataLine2_write(uint64_t v) {
	csr_write_simple(v >> 32, (CSR_BASE + 0x810L));
	csr_write_simple(v, (CSR_BASE + 0x814L));
}
#define CSR_PANTALLA_ADDRWRITE_ADDR (CSR_BASE + 0x818L)
#define CSR_PANTALLA_ADDRWRITE_SIZE 1
static inline uint32_t pantalla_addrWrite_read(void) {
	return csr_read_simple((CSR_BASE + 0x818L));
}
static inline void pantalla_addrWrite_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x818L));
}
#define CSR_PANTALLA_RAMTIME_ADDR (CSR_BASE + 0x81cL)
#define CSR_PANTALLA_RAMTIME_SIZE 1
static inline uint32_t pantalla_RamTime_read(void) {
	return csr_read_simple((CSR_BASE + 0x81cL));
}
static inline void pantalla_RamTime_write(uint32_t v) {
	csr_write_simple(v, (CSR_BASE + 0x81cL));
}
#define CSR_PANTALLA_REQUIREDATA_ADDR (CSR_BASE + 0x820L)
#define CSR_PANTALLA_REQUIREDATA_SIZE 1
static inline uint32_t pantalla_requireData_read(void) {
