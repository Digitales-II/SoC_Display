...
//
// Filename   : tarjeta_luis.v
// Device     : LFE5U-25F-6BG256C
// LiteX sha1 : 34ec22f8
// Date       : 2023-06-25 22:09:10
//------------------------------------------------------------------------------
...
module tarjeta_luis (
    ...
    output wire          pads_pantalla0_o_data_clock,
    output wire          pads_pantalla0_o_data_latch,
    output wire          pads_pantalla0_o_data_blank,
    output wire          pads_pantalla0_led,
    output wire    [4:0] pads_pantalla0_o_row_select,
    output wire    [1:0] pads_pantalla0_o_data_r,
    output wire    [1:0] pads_pantalla0_o_data_g,
    output wire    [1:0] pads_pantalla0_o_data_b,
    output wire    [1:0] pads_pantalla0_o_data_r2,
    output wire    [1:0] pads_pantalla0_o_data_g2,
    output wire    [1:0] pads_pantalla0_o_data_b2
);
...
reg           wr_storage = 1'd0;
reg           wr_re = 1'd0;
reg    [35:0] dataLine1_storage = 36'd0;
reg           dataLine1_re = 1'd0;
reg    [35:0] dataLine2_storage = 36'd0;
reg           dataLine2_re = 1'd0;
reg    [11:0] addrWrite_storage = 12'd0;
reg           addrWrite_re = 1'd0;
reg    [29:0] RamTime_storage = 30'd0;
reg           RamTime_re = 1'd0;
wire          requireData_status;
wire          requireData_we;
reg           requireData_re = 1'd0;
...
reg           csr_bankarray_csrbank2_wr0_re = 1'd0;
wire          csr_bankarray_csrbank2_wr0_r;
reg           csr_bankarray_csrbank2_wr0_we = 1'd0;
wire          csr_bankarray_csrbank2_wr0_w;
reg           csr_bankarray_csrbank2_dataLine11_re = 1'd0;
wire    [3:0] csr_bankarray_csrbank2_dataLine11_r;
reg           csr_bankarray_csrbank2_dataLine11_we = 1'd0;
wire    [3:0] csr_bankarray_csrbank2_dataLine11_w;
reg           csr_bankarray_csrbank2_dataLine10_re = 1'd0;
wire   [31:0] csr_bankarray_csrbank2_dataLine10_r;
reg           csr_bankarray_csrbank2_dataLine10_we = 1'd0;
wire   [31:0] csr_bankarray_csrbank2_dataLine10_w;
reg           csr_bankarray_csrbank2_dataLine21_re = 1'd0;
wire    [3:0] csr_bankarray_csrbank2_dataLine21_r;
reg           csr_bankarray_csrbank2_dataLine21_we = 1'd0;
wire    [3:0] csr_bankarray_csrbank2_dataLine21_w;
reg           csr_bankarray_csrbank2_dataLine20_re = 1'd0;
wire   [31:0] csr_bankarray_csrbank2_dataLine20_r;
reg           csr_bankarray_csrbank2_dataLine20_we = 1'd0;
wire   [31:0] csr_bankarray_csrbank2_dataLine20_w;
reg           csr_bankarray_csrbank2_addrWrite0_re = 1'd0;
wire   [11:0] csr_bankarray_csrbank2_addrWrite0_r;
reg           csr_bankarray_csrbank2_addrWrite0_we = 1'd0;
wire   [11:0] csr_bankarray_csrbank2_addrWrite0_w;
reg           csr_bankarray_csrbank2_RamTime0_re = 1'd0;
wire   [29:0] csr_bankarray_csrbank2_RamTime0_r;
reg           csr_bankarray_csrbank2_RamTime0_we = 1'd0;
wire   [29:0] csr_bankarray_csrbank2_RamTime0_w;
reg           csr_bankarray_csrbank2_requireData_re = 1'd0;
wire          csr_bankarray_csrbank2_requireData_r;
reg           csr_bankarray_csrbank2_requireData_we = 1'd0;
wire          csr_bankarray_csrbank2_requireData_w;
...
always @(*) begin
    ...
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd0))) begin
        ...
        csr_bankarray_csrbank2_enable0_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_wr0_r = csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
    csr_bankarray_csrbank2_wr0_we <= 1'd0;
    csr_bankarray_csrbank2_wr0_re <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 1'd1))) begin
        csr_bankarray_csrbank2_wr0_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_wr0_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_dataLine11_r = csr_bankarray_interface2_bank_bus_dat_w[3:0];
always @(*) begin
    csr_bankarray_csrbank2_dataLine11_we <= 1'd0;
    csr_bankarray_csrbank2_dataLine11_re <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 2'd2))) begin
        csr_bankarray_csrbank2_dataLine11_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_dataLine11_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_dataLine10_r = csr_bankarray_interface2_bank_bus_dat_w[31:0];
always @(*) begin
    csr_bankarray_csrbank2_dataLine10_re <= 1'd0;
    csr_bankarray_csrbank2_dataLine10_we <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 2'd3))) begin
        csr_bankarray_csrbank2_dataLine10_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_dataLine10_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_dataLine21_r = csr_bankarray_interface2_bank_bus_dat_w[3:0];
always @(*) begin
    csr_bankarray_csrbank2_dataLine21_we <= 1'd0;
    csr_bankarray_csrbank2_dataLine21_re <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 3'd4))) begin
        csr_bankarray_csrbank2_dataLine21_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_dataLine21_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_dataLine20_r = csr_bankarray_interface2_bank_bus_dat_w[31:0];
always @(*) begin
    csr_bankarray_csrbank2_dataLine20_re <= 1'd0;
    csr_bankarray_csrbank2_dataLine20_we <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 3'd5))) begin
        csr_bankarray_csrbank2_dataLine20_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_dataLine20_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_addrWrite0_r = csr_bankarray_interface2_bank_bus_dat_w[11:0];
always @(*) begin
    csr_bankarray_csrbank2_addrWrite0_re <= 1'd0;
    csr_bankarray_csrbank2_addrWrite0_we <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 3'd6))) begin
        csr_bankarray_csrbank2_addrWrite0_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_addrWrite0_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_RamTime0_r = csr_bankarray_interface2_bank_bus_dat_w[29:0];
always @(*) begin
    csr_bankarray_csrbank2_RamTime0_we <= 1'd0;
    csr_bankarray_csrbank2_RamTime0_re <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 3'd7))) begin
        csr_bankarray_csrbank2_RamTime0_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_RamTime0_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_requireData_r = csr_bankarray_interface2_bank_bus_dat_w[0];
always @(*) begin
    csr_bankarray_csrbank2_requireData_re <= 1'd0;
    csr_bankarray_csrbank2_requireData_we <= 1'd0;
    if ((csr_bankarray_csrbank2_sel & (csr_bankarray_interface2_bank_bus_adr[8:0] == 4'd8))) begin
        csr_bankarray_csrbank2_requireData_re <= csr_bankarray_interface2_bank_bus_we;
        csr_bankarray_csrbank2_requireData_we <= (~csr_bankarray_interface2_bank_bus_we);
    end
end
assign csr_bankarray_csrbank2_enable0_w = enable_storage;
assign csr_bankarray_csrbank2_wr0_w = wr_storage;
assign csr_bankarray_csrbank2_dataLine11_w = dataLine1_storage[35:32];
assign csr_bankarray_csrbank2_dataLine10_w = dataLine1_storage[31:0];
assign csr_bankarray_csrbank2_dataLine21_w = dataLine2_storage[35:32];
assign csr_bankarray_csrbank2_dataLine20_w = dataLine2_storage[31:0];
assign csr_bankarray_csrbank2_addrWrite0_w = addrWrite_storage[11:0];
assign csr_bankarray_csrbank2_RamTime0_w = RamTime_storage[29:0];
assign csr_bankarray_csrbank2_requireData_w = requireData_status;
assign requireData_we = csr_bankarray_csrbank2_requireData_we;
...
always @(posedge sys_clk) begin
    ...
    if (csr_bankarray_csrbank2_sel) begin
        case (csr_bankarray_interface2_bank_bus_adr[8:0])
            ...
            1'd1: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_wr0_w;
            end
            2'd2: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_dataLine11_w;
            end
            2'd3: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_dataLine10_w;
            end
            3'd4: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_dataLine21_w;
            end
            3'd5: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_dataLine20_w;
            end
            3'd6: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_addrWrite0_w;
            end
            3'd7: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_RamTime0_w;
            end
            4'd8: begin
                csr_bankarray_interface2_bank_bus_dat_r <= csr_bankarray_csrbank2_requireData_w;
            end
        endcase
    end
    if (csr_bankarray_csrbank2_enable0_re) begin
        enable_storage <= csr_bankarray_csrbank2_enable0_r;
    end
    enable_re <= csr_bankarray_csrbank2_enable0_re;
    if (csr_bankarray_csrbank2_wr0_re) begin
        wr_storage <= csr_bankarray_csrbank2_wr0_r;
    end
    wr_re <= csr_bankarray_csrbank2_wr0_re;
    if (csr_bankarray_csrbank2_dataLine11_re) begin
        dataLine1_storage[35:32] <= csr_bankarray_csrbank2_dataLine11_r;
    end
    if (csr_bankarray_csrbank2_dataLine10_re) begin
        dataLine1_storage[31:0] <= csr_bankarray_csrbank2_dataLine10_r;
    end
    dataLine1_re <= csr_bankarray_csrbank2_dataLine10_re;
    if (csr_bankarray_csrbank2_dataLine21_re) begin
        dataLine2_storage[35:32] <= csr_bankarray_csrbank2_dataLine21_r;
    end
    if (csr_bankarray_csrbank2_dataLine20_re) begin
        dataLine2_storage[31:0] <= csr_bankarray_csrbank2_dataLine20_r;
    end
    dataLine2_re <= csr_bankarray_csrbank2_dataLine20_re;
    if (csr_bankarray_csrbank2_addrWrite0_re) begin
        addrWrite_storage[11:0] <= csr_bankarray_csrbank2_addrWrite0_r;
    end
    addrWrite_re <= csr_bankarray_csrbank2_addrWrite0_re;
    if (csr_bankarray_csrbank2_RamTime0_re) begin
        RamTime_storage[29:0] <= csr_bankarray_csrbank2_RamTime0_r;
    end
    RamTime_re <= csr_bankarray_csrbank2_RamTime0_re;
    requireData_re <= csr_bankarray_csrbank2_requireData_re;
    ...
    if (sys_rst) begin
        ...
        wr_storage <= 1'd0;
        wr_re <= 1'd0;
        dataLine1_storage <= 36'd0;
        dataLine1_re <= 1'd0;
        dataLine2_storage <= 36'd0;
        dataLine2_re <= 1'd0;
        addrWrite_storage <= 12'd0;
        addrWrite_re <= 1'd0;
        RamTime_storage <= 30'd0;
        RamTime_re <= 1'd0;
        requireData_re <= 1'd0;
        grant <= 1'd0;
        slave_sel_r <= 4'd0;
...
//------------------------------------------------------------------------------
// Memory rom: 6756-words x 32-bit
//------------------------------------------------------------------------------
// Port 0 | Read: Sync  | Write: ---- | 
reg [31:0] rom[0:6755];
initial begin
	$readmemh("tarjeta_luis_rom.init", rom);
end
reg [31:0] rom_dat0;
always @(posedge sys_clk) begin
	rom_dat0 <= rom[adr];
...
initial begin
	$readmemh("tarjeta_luis_sram.init", sram);
end
reg [10:0] sram_adr0;
always @(posedge sys_clk) begin
	if (sram0_we[0])
...
initial begin
	$readmemh("tarjeta_luis_main_ram.init", main_ram);
end
...
reg [7:0] mem[0:39];
initial begin
	$readmemh("tarjeta_luis_mem.init", mem);
end
reg [5:0] mem_adr0;
always @(posedge sys_clk) begin
...
led_control led_control(
	.RamTime(RamTime_storage),
	.addrWrite(addrWrite_storage),
	.dataLine1(dataLine1_storage),
	.dataLine2(dataLine2_storage),
	.enable(enable_storage),
	.i_clk_i(sys_clk),
	.wr(wr_storage),
	.led(pads_pantalla0_led),
	.o_data_b(pads_pantalla0_o_data_b),
	.o_data_b2(pads_pantalla0_o_data_b2),
	.o_data_blank(pads_pantalla0_o_data_blank),
	.o_data_clock(pads_pantalla0_o_data_clock),
	.o_data_g(pads_pantalla0_o_data_g),
	.o_data_g2(pads_pantalla0_o_data_g2),
	.o_data_latch(pads_pantalla0_o_data_latch),
	.o_data_r(pads_pantalla0_o_data_r),
	.o_data_r2(pads_pantalla0_o_data_r2),
	.o_row_select(pads_pantalla0_o_row_select),
	.requireData(requireData_status)
);
...
// -----------------------------------------------------------------------------
//  Auto-Generated by LiteX on 2023-06-25 22:09:10.
//------------------------------------------------------------------------------
